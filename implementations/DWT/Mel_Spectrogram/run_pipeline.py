...
wavelet_type = "HAAR" # HAAR or Daubechies4
levels = "three_level" # one_level or three_level or five_level or seven_level
input_shape = (40, 200, 1)  # depends on wavelet_type 40, 42, 74, 60, 46
...
# === Feature Paths ===
base_feature_path = f'D:/mine/Shsh/HIAST/projects/grad project/codes/LCNN-master/my_model/features/{feature_type}/{input_type}/{wavelet_type}/{levels}'
...
# === Weights ===
weights_dir = f"D:/mine/Shsh/HIAST/projects/grad project/codes/LCNN-master/my_model/weights/{feature_type}/{input_type}/{wavelet_type}/{levels}"
